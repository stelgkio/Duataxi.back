...
namespace DuaTaxi.Common.Handlers
{
	public class Handler : IHandler
	{
        ...
        private Func<DuaTaxiException, Task> _onCustomError;
        ...
        public IHandler OnCustomError(Func<DuaTaxiException, Task> onCustomError, bool rethrow = false)
        {
        ...
        public async Task ExecuteAsync()
        {
            ...
            catch (DuaTaxiException customException)
            {
                isFailure = true;
