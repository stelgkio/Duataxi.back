...
namespace DuaTaxi.Common.RabbitMq
{
    public class CorrelationContext : ICorrelationContext
    {
        ...
        [JsonConstructor]
        private CorrelationContext(string id, Guid userId, Guid resourceId, string traceId, string spanContext,
        ...
        public static ICorrelationContext FromId(string id)
        ...
        public static ICorrelationContext Create<T>(string id, Guid userId, Guid resourceId, string origin,
